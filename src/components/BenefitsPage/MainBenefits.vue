            ...
            <div>
              <ol class="jackfruitsText">
                ...
                <li>
                  ...
                  significant source of income for local Mexican farmers.
                  Choosing jackfruit supports these communities and encourages
                  sustainable agricultural practices.
                </li>
                <li>
                  <b>Promotes Food Security:</b> Jackfruit's versatility and
                  long shelf life make it a valuable food source in regions
                  facing food insecurity. Its drought tolerance further
                  strengthens its role in ensuring consistent food availability.
                </li>
                <li>
